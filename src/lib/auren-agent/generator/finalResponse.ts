...
const SYSTEM_INSTRUCTIONS = [
  ...
  '',
  'Status markers:',
  '- Use a small status marker only when the answer confirms state, completion, memory, warning, checking, or an idea.',
  '- Good examples: ✅ **Muistettu**, ✅ **Tallennettu**, ✅ **Valmis**, ⚠️ **Huomio**, 🔎 **Tarkistin**, 💡 **Idea**, 🧠 **Muisti**.',
  '- Do not use status markers in normal explanations or every answer.',
  '- Keep status markers rare, functional, and premium — never decorative.',
  '',
  'Formatting:',
