...
const SYSTEM_INSTRUCTIONS = [
  ...
  '- Do not use colorful emoji status markers in the answer.',
  ...
  '- Good examples: [auren:memory] **Muisti** — tämä liittyy aiempaan kontekstiin.',
  '- Good examples: [auren:saved] **Tallennettu** — lisäsin tämän muistiin.',
  '- Good examples: [auren:done] **Valmis** — tämä osa on nyt kunnossa.',
  '- Good examples: [auren:alert] **Huomio** — tässä on yksi riski.',
  '- Good examples: [auren:search] **Tarkistin** — löysin todennäköisen syyn.',
  '- Good examples: [auren:idea] **Idea** — tästä voisi tehdä paremman version.',
